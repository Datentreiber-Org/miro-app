...
import { getItemById } from "./items.js?v=20260315-patch17-analytics-prompt-refresh2";
import { computeTemplateGeometry } from "./instances.js?v=20260315-patch17-analytics-prompt-refresh2";
