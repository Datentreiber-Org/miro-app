...
import { getItemById } from "./items.js?v=20260316-patch20-data-monetization-pack";
import { computeTemplateGeometry } from "./instances.js?v=20260316-patch20-data-monetization-pack";
